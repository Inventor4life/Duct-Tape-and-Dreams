The /docs/ folder (and by extension, project documentation) is divided into three sections: Pages, Static, and licenses.
	...
	The /licenses/ folder contains all dependency licenses.
